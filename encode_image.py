...
parser.add_argument('--image_path', type=str, default='data1/imagenet/org/040322.jpg')
parser.add_argument('--out_dir', type=str, default='data1/imagenet/bd/')

...
if __name__ == '__main__':
    ...
    parser.add_argument("--epochs", type=int, default=230, help="number of epochs.")
    ...
    parser.add_argument("--pretrained_weights", type=str, default='checkpoints/ae_ckpt_36_0.862980.pth',help="if specified starts from checkpoint model")
    ...
    train_dataloader = DataLoader(train_ds, batch_size=batch_size, shuffle=False, num_workers=0)
